...
import { Hero, BaseItem, Jewel, Relic, SlotBonus, DailyEvent } from './types';

// --- DAILY EVENTS (V6.3 Rotation) ---
export const DAILY_EVENTS: DailyEvent[] = [
  {
    id: 'ucd',
    name: 'Up-Close Dangers',
    days: [0, 1, 3, 5], // Sun, Mon, Wed, Fri
    desc: 'The primary source of Gold and Player EXP.',
    loot: ['Gold (High)', 'EXP (High)'],
    strategy: 'Prioritize "Greed" and "Dodge" skills. Use Bull Rings for +10% Gold bonus. Stay mobile to avoid fast-moving melee units.',
  ...
  },
  {
    ...
    desc: 'Essential for farming Equipment and scrolls.',
    loot: ['Gear Drops', 'Weapon Scrolls'],
    strategy: 'Bosses appear every 5 rooms. High Projectile Resistance is key. Use Phantom Cloak to freeze high-threat ranged enemies.',
  ...
  },
  {
    ...
    name: 'Ancient Maze',
    days: [0, 1, 3, 5], // Sun, Mon, Wed, Fri
    desc: 'The only reliable way to earn Soulstones for Hero Shards.',
    loot: ['Soulstones', 'Evolution Chips'],
    strategy: 'Enter "Purple" portals for maximum Soulstone density. Blue portals focus on buffs, Green on healing.',
  ...
  },
  {
    ...
    name: 'Mystery Mine',
    days: [0, 2, 4, 6], // Sun, Tue, Thu, Sat
    desc: 'The main node for high-level Jewels and Minerals.',
    loot: ['Jewels (LV 1-3)', 'Minerals'],
    strategy: 'Selecting harder modifiers increases Jewel drop chance. Use Helix or Meowgik to handle the high density of tanky mobs.',
    color: 'from-teal-600 to-emerald-500',
    icon: 'Gem'
  },
  {
    id: 'infinite_adventure',
    name: 'Infinite Adventure',
    days: [0, 1, 2, 3, 4, 5, 6], // Everyday
    desc: 'A monthly endurance test for top rewards.',
    loot: ['Locket/Bracelet Shards', 'Seasonal Rewards'],
    strategy: 'Swap heroes at floor 100/200/300 to maximize stamina. Enlightenment book is mandatory for high-floor pushes.',
